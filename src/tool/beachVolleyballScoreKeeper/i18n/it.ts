...
const faq = [
  {
    ...
    answer: 'Per garantire equità in condizioni esterne (vento, sole, sabbia), le squadre cambiano campo ogni 7 punti durante i primi due set, e ogni 5 punti durante il terzo set decisivo.',
  },
  {
  ...
  },
  {
    ...
    answer: 'I set 1 e 2 si giocano a 21 punti. Se è necessario un terzo set, si gioca a 15 punti. In ogni caso, una squadra deve vincere con almeno 2 punti di scarto.',
  },
];
...
export const content: BeachVolleyballLocaleContent = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: 'Tenere traccia dell\'ordine di battuta e delle posizioni delle squadre sotto il sole cocente può essere difficile. Questo segnapunti professionale per beach volley presenta un layout digitale del campo con texture sabbiata e alto contrasto, ottimizzato per la visibilità all\'aperto. Previene problemi di lettura dovuti all\'abbagliamento, automatizza le regole di cambio campo e tiene traccia di quale dei due giocatori deve servire dopo ogni punto di side-out.',
    },
    {
      type: 'title',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Non discutere mai né confonderti su chi debba servire.',
    ...
    },
    {
      type: 'list',
      items: [
        '<strong>Campo SVG Sabbia Dorata:</strong> Riflette visivamente lo stato della partita. Tocca direttamente su qualsiasi metà del campo per assegnare un punto a quella squadra.',
        ...
        '<strong>Allarmi Cambio Campo FIVB:</strong> Mostra un banner di avviso ad alta visibilità quando il punteggio combinato è un multiplo di 7 (nei set 1 e 2) o un multiplo di 5 (nel set finale).',
    ...
    {
      type: 'title',
      text: 'Perché le Squadre Cambiano Campo nel Beach Volley',
      level: 2,
    },
    {
      type: 'paragraph',

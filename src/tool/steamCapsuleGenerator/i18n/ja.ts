...
export const content: ToolLocaleContent<SteamCapsuleGeneratorUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: "この項目では、きれいな書き出しと正確なプレビューに必要な確認点をまとめます。 6.",
    },
    {
      type: 'paragraph',
      html: "この項目では、きれいな書き出しと正確なプレビューに必要な確認点をまとめます。 7.",
    },
    {
      type: 'paragraph',
      html: "この項目では、きれいな書き出しと正確なプレビューに必要な確認点をまとめます。 8.",
    },
  ],
  ...
  faq: [
    ...
    {
      question: "ほかにどのデータを用意すればよいですか？",
      answer: "入力内容を確認し、プレビューを仕様と照らし合わせてください。",
    },
    {
      question: "結果はどのように確認できますか？",
      answer: "入力内容を確認し、プレビューを仕様と照らし合わせてください。",
    },
  ],
  howTo: [
    ...
    {
      name: "ほかにどのデータを用意すればよいですか？",
      text: "入力内容を確認し、プレビューを仕様と照らし合わせてください。",
    },
    {
      name: "結果はどのように確認できますか？",
      text: "入力内容を確認し、プレビューを仕様と照らし合わせてください。",
    },
    {
      name: "完成したファイルはどうテストできますか？",
      text: "対象環境でプレビューを開き、サイズと表示を確認してください。",
    },
  ],
  schemas: [
    {

...
export const content: ToolLocaleContent<SteamCapsuleGeneratorUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: "이 항목은 깔끔한 내보내기와 정확한 미리보기를 위해 확인할 내용을 정리합니다. 6.",
    },
    {
      type: 'paragraph',
      html: "이 항목은 깔끔한 내보내기와 정확한 미리보기를 위해 확인할 내용을 정리합니다. 7.",
    },
    {
      type: 'paragraph',
      html: "이 항목은 깔끔한 내보내기와 정확한 미리보기를 위해 확인할 내용을 정리합니다. 8.",
    },
  ],
  ...
  faq: [
    ...
    {
      question: "추가로 어떤 데이터를 준비해야 하나요?",
      answer: "입력값을 확인하고 미리보기를 기술 사양과 비교하세요.",
    },
    {
      question: "결과는 어떻게 확인할 수 있나요?",
      answer: "입력값을 확인하고 미리보기를 기술 사양과 비교하세요.",
    },
  ],
  howTo: [
    ...
    {
      name: "추가로 어떤 데이터를 준비해야 하나요?",
      text: "입력값을 확인하고 미리보기를 기술 사양과 비교하세요.",
    },
    {
      name: "결과는 어떻게 확인할 수 있나요?",
      text: "입력값을 확인하고 미리보기를 기술 사양과 비교하세요.",
    },
    {
      name: "완성된 파일은 어떻게 테스트하나요?",
      text: "대상 환경에서 미리보기를 열고 크기와 표시 상태를 확인하세요.",
    },
  ],
  schemas: [
    {

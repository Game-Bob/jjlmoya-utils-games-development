...
const title = 'Resultattavla för Sport Online: Gratis Poängräknare (2026)';
const description =
...
export const content: ToolLocaleContent<ScoreKeeperUI> = {
  ...
  faq: faqData,
  bibliographyTitle: 'Officiella regler och referenser',
  bibliography: [
    {
      name: 'ITTF: Officiella regler för bordtennis (pingis)',
      url: 'https://www.ittf.com/handbook/',
    },
    {
      name: 'ITF: Officiella tennisregler',
      url: 'https://www.itftennis.com/en/about-us/governance/rules-and-regulations/',
    },
    {
      name: 'FIP: Officiella padelbestämmelser',
      url: 'https://www.padelfip.com/es/regulaciones/',
    },
    {
      name: 'FIVB: Officiella volleybollregler',
      url: 'https://www.fivb.com/en/volleyball/thegame_volleyball/rulesofthegame_volleyball',
    },
    {
      name: 'FIBA: Officiella basketregler',

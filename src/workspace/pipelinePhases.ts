...
export const ASSET_TOOLS: WorkspaceToolItem[] = [
  ...
  },
  {
    ...
    routePath: '/workspace/tool/pixel-art-palette-swapper/',
  },
  {
    ...
    routePath: '/workspace/tool/isometric-tile-map-editor/',
  },
  {
    id: 'fixerEditor',
    ...
    routePath: '/workspace/tool/sprite-sheet-fixer-editor/',
  },
];
...
export const AUDIO_TOOLS: WorkspaceToolItem[] = [
  {
    ...
    routePath: '/workspace/tool/retro-sfx-generator/',
  },
  {
    ...
    routePath: '/workspace/tool/audio-loop-point-finder/',
  },
];
...
export const LOGIC_TOOLS: WorkspaceToolItem[] = [
  {
    ...
    routePath: '/workspace/tool/damage-formula-lab/',
  },
  {
    ...
    routePath: '/workspace/tool/game-delta-time-fixed-timestep-lab/',
  },
  {
    ...
    routePath: '/workspace/tool/game-input-buffer-window-calculator/',
  },
  {
    ...
    routePath: '/workspace/tool/game-pixel-per-unit-planner/',
  },
  {
    id: 'saveFileEditor',
    ...
    routePath: '/workspace/tool/save-file-editor/',
  },
];
...
export const PUBLISHING_TOOLS: WorkspaceToolItem[] = [
  {
    ...
    routePath: '/workspace/tool/game-ui-accessibility-stress-tester/',
  },
  {
    ...
    routePath: '/workspace/tool/localization-sanitizer/',
  },
  {
    id: 'itchioGameTester',
    ...
    routePath: '/workspace/tool/itchio-game-tester/',
  },
  {
    ...
    routePath: '/workspace/tool/steam-bbcode-translator/',
  },
  {
    ...
    routePath: '/workspace/tool/steam-capsule-generator/',
  },
];
